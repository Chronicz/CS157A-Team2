DROP SCHEMA IF EXISTS `cozyfirm`;
...
CREATE TABLE `cozyfirm`.`wishlistitems`( 
...
VALUES
    ('1', 'johnDoe', '$2b$10$K/QwJNXvKe3Jw1o1NuFT9.xYRFTfKKWRX2XCnWgCnixuCFEyKe8Ha', 'John', 'Doe'), -- password123
    ('2', 'janeSmith', '$2b$10$5jyvjEFg8fc.dwsa4ZI6ueFEs5oIfFcMMU905lwdxMF9x9VP3uKa.', 'Jane', 'Smith'), -- ilovecats
    ('3', 'bobJohnson', '$2b$10$YSKNcN222/aAwUXUq/ZFq.rG70hp3wo6HNaMnYgYh9HGwto0sklam', 'Bob', 'Johnson'), -- qwertyuiop
    ('4', 'aliceBrown', '$2b$10$MprL4e31dCjR7imDI3Edf.ZCi/TgsflCmK.kBt4Lm11xWHguSnGj2', 'Alice', 'Brown'), -- letmein
    ('5', 'mikeDavis', '$2b$10$X7zOLcpBvPjPhEpjI/OIdOco/ZuvqwobvW2L807u95iI0ylGN4dDa', 'Mike', 'Davis'), -- mike123
    ('6', 'emilyTaylor', '$2b$10$fUQ8Ry16PQ1jb7MQ5PGxiOCnCy5GXevpfXpaz.glY6UMdU.CTn9qy', 'Emily', 'Taylor'), -- emily88
    ('7', 'sarahLee', '$2b$10$8hOqScc74LJ6fwi9fQcauuQqBFLcC1/E.zytZLr9CHCP0sVPV/iwe', 'Sarah', 'Lee'), -- sarah123
    ('8', 'kevinWhite', '$2b$10$vp/4bxYYp4z.ryxkZup2je/v/vOtn4RLRl/6rQ//rb2ekWyegAUgO', 'Kevin', 'White'), -- kevin99
    ('9', 'lisaHall', '$2b$10$1VeFqCrKBUbXwRAdC4s3YeriT0CPmifrVE9PJzhBKP0m0Mwji6PCS', 'Lisa', 'Hall'), -- lisa123
    ('10', 'tomHarris', '$2b$10$jzTuNG2GEb3B9brxtR3ps.RZUbe4JbScj5tlrTBKEFMWSx0iAeAia', 'Tom', 'Harris'); -- tom1234
